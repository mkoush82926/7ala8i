...
export default function LoginPage() {
    ...
    async function handleSubmit(formData: FormData) {
        ...
        // if successful, auth/actions does redirect('/')
    }
        ...
        <div className="min-h-screen bg-app-bg text-app-text flex flex-col items-center justify-center p-4">
            ...
            >
                <div className="text-center mb-8 flex flex-col items-center">
                    ...
                    <p className="text-app-text-muted mt-2">Sign in to your Lumina workspace</p>
                </div>
                ...
                <GlassCard className="p-8">
                    <form action={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                ...
                                <Link href="#" className="text-xs text-app-accent-mint hover:underline">Forgot password?</Link>
                            </div>
                            <input
                                type="password"
                                name="password"
                    ...
                    <div className="mt-6 text-center text-sm text-app-text-muted">
                        ...
                        <Link href="/signup" className="text-app-accent-mint hover:underline font-medium">
                            Start for free
                        </Link>
                    </div>
                </GlassCard>
