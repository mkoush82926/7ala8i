...
function useStages() {
    ...
    return [
        { id: "new" as LeadStage, label: t.leads.newLead, color: "var(--accent-blue)" },
        { id: "contacted" as LeadStage, label: t.leads.contacted, color: "var(--accent-lavender)" },
        { id: "booked" as LeadStage, label: t.leads.bookedPackage, color: "var(--accent-amber)" },
        { id: "completed" as LeadStage, label: t.leads.completedStage, color: "var(--accent-mint)" },
        { id: "loyal" as LeadStage, label: t.leads.loyal, color: "var(--accent-rose)" },
    ];
}
...
export function KanbanBoard() {
    ...
    function handleNewLead() {
        ...
        const newLead = { id, name: "New Lead", phone: "", stage: "new" as LeadStage, createdAt: new Date().toISOString().split("T")[0] };
        selectLead(newLead);
    }
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-[13px] text-[var(--text-secondary)] mt-1 font-light">
                        {leads.length} {t.leads.leadsAcross} {stages.length} {t.leads.stages}
                    </p>
                </div>
...
function LeadListView({
    ...
    const stageColors: Record<string, string> = {
        ...
        contacted: "text-[var(--accent-lavender)] bg-[var(--accent-lavender-muted)]",
