...
export function LeadDrawer() {
    ...
    const stageOptions: { value: LeadStage; label: string; color: string }[] = [
        ...
        { value: "contacted", label: t.leads.contacted, color: "var(--accent-lavender)" },
        { value: "booked", label: t.leads.bookedPackage, color: "var(--accent-amber)" },
        { value: "completed", label: t.leads.completedStage, color: "var(--accent-mint)" },
                ...
                <>
                    ...
                    <motion.div
                        ...
                        className={cn(
                            ...
                            isRTL ? "left-0 border-r border-[var(--border-primary)]" : "right-0 border-l border-[var(--border-primary)]"
                        )}
                    >
                        {/* Header */}
