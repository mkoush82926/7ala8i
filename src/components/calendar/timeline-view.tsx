        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <h2 className="text-[20px] tracking-tight text-[var(--text-primary)] font-light">Calendar</h2>
                    ...
                    <div className="flex items-center bg-[var(--bg-surface)] rounded-[var(--radius-sm)] p-0.5">
                        <button
                            ...
                            className={cn(
                                ...
                                view === "timeline" ? "text-[var(--text-primary)]" : "text-[var(--text-tertiary)]"
                            )}
                        >
                            {view === "timeline" && (
                                <motion.div
                        ...
                        <button
                            ...
                            className={cn(
                                "relative px-2.5 py-1.5 rounded-[var(--radius-sm)] cursor-pointer z-10",
                                view === "list" ? "text-[var(--text-primary)]" : "text-[var(--text-tertiary)]"
                            )}
                        >
                            {view === "list" && (
                                <motion.div
                                            ...
                                            return (
                                                <motion.div
                                                    ...
                                                    className={cn(
                                                        ...
                                                        appt.status === "confirmed" ? "hover:shadow-glow-blue" :
                                                            appt.status === "completed" ? "hover:shadow-glow-mint" :
                                                                appt.status === "no-show" ? "hover:shadow-glow-rose" : ""
                                                    )}
                                                    style={{
                                                ...
                                                >
                                                    ...
                                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-max min-w-[140px] p-2 rounded-lg bg-[var(--bg-secondary)] border border-[var(--border-primary)] shadow-xl opacity-0 scale-95 pointer-events-none group-hover:opacity-100 group-hover:scale-100 transition-all z-50 flex flex-col gap-1">
                                                        <p className="text-[12px] text-[var(--text-primary)] font-medium">{appt.clientName}</p>
                                                        <p className="text-[10px] text-[var(--text-secondary)]">{appt.service} • {appt.duration} min</p>
                                                        <div className="flex items-center gap-1 mt-1">
                                                            <div className={cn("w-1.5 h-1.5 rounded-full", colors.bg, `border ${colors.border}`)} />
                                                            <span className="text-[9px] text-[var(--text-tertiary)] capitalize">{appt.status === "no-show" ? "No Show" : appt.status}</span>
                                                        </div>
                                                    </div>
                                                </motion.div>
                                            );
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-[var(--border-primary)]">
                                    {["Time", "Client", "Service", "Barber", "Price", "Status"].map(
                                        (h) => (
                                            <th
                                                key={h}
                                            ...
                                            <td className="px-4 py-3">
                                                <span
                                                    className={cn(
                                                        ...
                                                        appt.status === "confirmed" ? "hover:shadow-glow-blue" :
                                                            appt.status === "completed" ? "hover:shadow-glow-mint" :
                                                                appt.status === "no-show" ? "hover:shadow-[0_0_20px_rgba(244,63,94,0.2)]" : ""
                                                    )}
                                                >
