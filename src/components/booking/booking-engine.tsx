                            ...
                            >
                                ...
                                <div className="flex items-center justify-center gap-1 mb-8">
                                    {Array.from({ length: 5 }).map((_, i) => (
                                        <Star
                                            ...
                                            size={12}
                                            className={cn(
                                                i < 4 ? "text-[var(--accent-amber)] fill-[var(--accent-amber)]" : "text-[var(--text-muted)]"
                                            )}
                                        />
                                    ))}
                                ...
                                <div className="w-full h-32 rounded-[var(--radius-md)] bg-[var(--bg-surface)] border border-[var(--border-primary)] flex items-center justify-center mb-8">
                                    <div className="text-center">
                                        <MapPin size={20} className="text-[var(--text-muted)] mx-auto mb-1" />
                                        <p className="text-[10px] text-[var(--text-muted)]">Interactive Map</p>
                                    </div>
                                </div>
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex items-center justify-between mb-2">
                                                    ...
                                                    >
                                                        {serviceIcons[service.icon] || <Scissors size={16} />}
                                                    </div>
                                                    {isSelected && (
                                                        <motion.div
                                                            initial={{ scale: 0 }}
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="grid grid-cols-4 gap-2">
                                        {availableTimes.map((time) => {
                                            const isOccupied = occupiedSlots[selectedDate]?.includes(time);
                                            return (
                                                <button
                                                    key={time}
                                                    disabled={isOccupied}
                                ...
                                <div className="mt-6 space-y-3">
                                    <div className="p-4 rounded-[var(--radius-md)] bg-[var(--bg-surface)] border border-[var(--border-primary)] space-y-2">
                                        <div className="flex justify-between text-[12px]">
                                            <span className="text-[var(--text-tertiary)]">{t.booking.services}</span>
                                        ...
                                        <div className="flex justify-between text-[12px]">
                                            <span className="text-[var(--text-tertiary)]">{t.calendar.barber}</span>
                                            <span className="text-[var(--text-primary)] font-light">
                                                {selectedBarberName}
                                            </span>
                                        </div>
                                        <div className="flex justify-between text-[12px]">
                                            <span className="text-[var(--text-tertiary)]">{t.booking.date}</span>
                                            <span className="text-[var(--text-primary)] font-light tabular-nums">
                                                {selectedDate} at {selectedTime}
                                            </span>
                                        </div>
                                        <div className="flex justify-between text-[12px]">
                                            <span className="text-[var(--text-tertiary)]">{t.calendar.duration}</span>
                                            <span className="text-[var(--text-primary)] font-light">
                                                {totalDuration} min
                                            </span>
                                        </div>
                                        <div className="pt-2 border-t border-dashed border-[var(--border-primary)] flex justify-between text-[13px]">
                                            <span className="text-[var(--text-primary)] font-medium">{t.booking.total}</span>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        >
                                            <option value="">{t.booking.howDidYouHear} ({t.common.optional})</option>
                            ...
                            >
                                ...
                                <div className="p-4 rounded-[var(--radius-md)] bg-[var(--bg-surface)] border border-[var(--border-primary)] text-left mb-6">
                                    <div className="flex justify-between text-[12px] mb-2">
                                        <span className="text-[var(--text-tertiary)]">{t.booking.location}</span>
                                        <span className="text-[var(--text-primary)] font-light">Rainbow St, Amman</span>
                                    </div>
                                    <div className="flex justify-between text-[12px] mb-2">
                                        <span className="text-[var(--text-tertiary)]">{t.booking.payment}</span>
                                        <span className="text-[var(--accent-mint)] font-medium">
    ...
    return (
        <div className="flex items-center gap-3">
            ...
            <div>
                ...
                <h3 className="text-[15px] text-[var(--text-primary)] font-light">{title}</h3>
            </div>
        </div>
    );
}
